 ...
 */
extern "C" struct SwsContext *sws_getContext(int srcW, int srcH, enum PixelFormat srcFormat,
 ...
 */
extern "C" int sws_scale(struct SwsContext *context, uint8_t* srcSlice[], int srcStride[],
