...
const AMOVIESETUP_FILTER sudJRtpRecVideo = 
{
	& CLSID_JRtpRecVideo,		// Filter CLSID
	L"JRtpRecVideo",				// Filter name
	MERIT_DO_NOT_USE,			// Filter merit
	1,							// Number of pins  MERIT_DO_NOT_USE MERIT_NORMAL
